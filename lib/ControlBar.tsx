...
import { useMaybeLayoutContext, useMaybeRoomContext } from '@livekit/components-react';
    ...
    return (
        <div {...htmlProps}>
            ...
            {visibleControls.agent && (
                <button
                    className="lk-button lk-button-agent"
                    onClick={() => {
                        fetch('/api/agent', {
                            method: 'POST',
            ...
            {visibleControls.transcription && (
                <button
                    className="lk-button lk-button-transcription"
